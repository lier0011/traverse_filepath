...
if __name__ == "__main__":
    ...
    parser.add_option('-p', '--path', help='specify the path to traverse')
    parser.add_option('-c', '--limit_count', help='limited number of results')
    parser.add_option('-f', '--limit_min_file_size', help='minimum limit of the file size in bytes')
